      ...
      <S.MyNotificationDetailBox>
        ...
        <S.MyNotificationDetail>
          ...
          <S.MyNotification>
            ...
            {fileData &&fileData.length > 0 && fileData.map(
                (FileData: FileData, idx: number) => (
                  <S.MyNotificationFileWrap
                    ...
                    <S.MyNotificationFile>
                      ...
                      <S.FileDownLoadWrap onClick={() => HandleFileDownLoad(FileData.fileUrl)}>
            ...
            {commentData && commentData.length > 0 && 
              commentData.map(
                (CommentData: CommentData) => (
                  <CommentList key={CommentData.commentId} comment={CommentData}/>
                )
              )}
          </S.CommentListBox>
          <Comment />
