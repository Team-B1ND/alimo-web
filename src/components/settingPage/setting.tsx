    ...
    <S.Setting  onClick={()=>onClose()}>
      <S.SettingMain>
        ...
        <S.Settingexplanation onClick={()=>onClose()} >
          ...
          <S.SettingDetail>
            <span onClick={()=>window.open("https://alimo.b1nd.com/detailed-information/personal-information")}>개인정보 이용 약관</span>
          </S.SettingDetail>
          <S.SettingDetail>
            <span onClick={()=>window.open("https://alimo.b1nd.com/detailed-information/usage-guide")}>사용방법</span>
          </S.SettingDetail>
